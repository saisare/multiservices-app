-- ================================================
-- CRÉATION SCHÉMA IMMIGRATION SERVICE
-- ================================================
...
CREATE TABLE IF NOT EXISTS dossiers (
    ...
    date_derniere_actualisation TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    statut ENUM('CREATION', 'INCOMPLET', 'COMPLETE', 'ACCEPTE', 'REJETE', 'EXPIRANT') DEFAULT 'CREATION',
    motif_rejet TEXT,
    date_rejet DATE,
