-- ==========================================
-- BD MICROSERVICES CORRECTE
-- ==========================================

-- ============ AUTH_DB (Gestion Users + Auth) ============
...
-- ============ BTP_DB (Données BTP ISOLÉES) ============

CREATE DATABASE IF NOT EXISTS btp_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE btp_db;
...
VALUES ('CH001', 'Construction Immeuble A', '123 Rue de Paris', '2026-01-15', 'EN_COURS', 500000, 2);

-- ============ ASSURANCE_DB (Données Assurances ISOLÉES) ============
...
-- ============ RH_DB (Données RH ISOLÉES) ============

CREATE DATABASE IF NOT EXISTS rh_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE rh_db;
...
-- ============ VOYAGE_DB (Données Voyage ISOLÉES) ============

CREATE DATABASE IF NOT EXISTS voyage_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE voyage_db;
...
-- ============ LOGISTIQUE_DB (Données Logistique ISOLÉES) ============

CREATE DATABASE IF NOT EXISTS logistique_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE logistique_db;

CREATE TABLE produits_logistique (
    id INT AUTO_INCREMENT PRIMARY KEY,
