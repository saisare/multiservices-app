...
export default function DashboardVoyageError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('🔵 VOYAGE MODULE ERROR:', error);
  }, [error]);
    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-50">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-blue-600 mb-4">⚠️ Erreur Voyage</h1>
          <p className="text-gray-700 mb-4">
            Un problème s'est produit dans le module Voyage.
          </p>
